  ...
  return (
    <>
      <style>{`
        ...
        .saved-filter-btn { padding:0.42rem 1rem; border-radius:100px; border:1px solid rgba(255,255,255,0.1); background:transparent; color:rgba(255,255,255,0.45); font:600 0.8rem 'DM Sans',sans-serif; cursor:pointer; transition:all 0.18s; }
        ...
        .saved-filter-count { display:inline-flex; align-items:center; justify-content:center; width:18px; height:18px; border-radius:50%; background:rgba(232,82,42,0.25); font-size:0.65rem; font-weight:700; margin-left:0.3rem; }

        /* Card list */
        .saved-list { display:flex; flex-direction:column; gap:0.9rem; }

        /* Shared card shell */
        .saved-card { background:rgba(22,22,22,0.75); border:1px solid rgba(255,255,255,0.07); border-radius:18px; backdrop-filter:blur(12px); overflow:hidden; transition:border-color 0.2s; }
        ...
        .saved-card-title { font-family:'Syne',sans-serif; font-size:1rem; font-weight:700; margin:0 0 0.35rem; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }
        ...
        .saved-btn { font:600 0.78rem 'DM Sans',sans-serif; cursor:pointer; padding:0.42rem 0.85rem; border-radius:100px; border:1px solid rgba(255,255,255,0.1); background:transparent; color:rgba(255,255,255,0.55); transition:all 0.18s; white-space:nowrap; text-decoration:none; display:inline-flex; align-items:center; justify-content:center; }
        ...
        .saved-step-text { font-size:0.88rem; color:rgba(255,255,255,0.7); line-height:1.65; }

        /* References in expanded panel */
        .saved-refs { margin-top:0.4rem; }
        .saved-refs-label { font-size:0.68rem; font-weight:700; text-transform:uppercase; letter-spacing:1.3px; color:rgba(255,255,255,0.3); margin:0 0 0.6rem; }
        .saved-ref-list { display:flex; flex-wrap:wrap; gap:0.45rem; }
        .saved-ref-item { display:inline-flex; align-items:center; gap:0.35rem; padding:0.3rem 0.7rem; background:rgba(255,255,255,0.03); border:1px solid rgba(255,255,255,0.07); border-radius:100px; text-decoration:none; font-size:0.72rem; font-weight:600; color:rgba(255,255,255,0.45); transition:all 0.18s; }
