  ...
  return (
    <>
      <style>{`
        ...
        .fl-banner { font-size: 0.8rem; color: rgba(255,255,255,0.45); padding: 0.65rem 1rem; border-radius: 12px; background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.08); margin-bottom: 1.2rem; }
        .fl-form { background: rgba(22,22,22,0.6); border: 1px solid rgba(255,255,255,0.07); border-radius: 16px; padding: 1.2rem 1.35rem; margin-bottom: 1.4rem; }
        .fl-form h3 { font-family: 'Syne', sans-serif; font-size: 0.95rem; font-weight: 800; margin: 0 0 0.9rem; }
        ...
        .fl-inp { width: 100%; padding: 0.55rem 0.75rem; border-radius: 10px; border: 1px solid rgba(255,255,255,0.1); background: rgba(255,255,255,0.04); color: #f2ede4; font-size: 0.84rem; outline: none; }
        .fl-inp:focus { border-color: rgba(232,82,42,0.45); }
      ...
      <div className="fl-wrap">
        ...
        {loading ? (
          <p style={{ color: 'rgba(255,255,255,0.4)', textAlign: 'center', padding: '2rem' }}>Loading your links…</p>
        ) : links.length === 0 ? (
          <p style={{ color: 'rgba(255,255,255,0.4)', textAlign: 'center', padding: '2rem', fontSize: '0.9rem' }}>
