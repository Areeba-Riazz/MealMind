...
export default function ChatWidget() {
  ...
  const hasPrefs = preferences.cuisines.length > 0 || preferences.budget || preferences.goal || preferences.customPreferences;
    ...
    try {
      ...
      const res = await fetch(`${apiBase}/api/chat`, {
        ...
        body: JSON.stringify({
          ...
          userPreferences: hasPrefs ? preferences : null,
        }),
      });
