...
export default function LandingPage() {
  ...
  const onDragStart = (x) => { setIsDragging(true); setDragStart(x); setDragDelta(0); clearInterval(timerRef.current); };
  ...
  return (
    <>
      ...
      {/* NAV */}
      <nav>
        <a href="#" className="nav-logo">Meal<span>Mind</span></a>
        ...
        <div className="nav-right">
          ...
          <Link href="/dashboard" className="btn-nav-main">Try Free 🚀</Link>
          <HamburgerButton />
        </div>
      </nav>
      ...
      <section className="hero">
        ...
        <div className="hero-btns">
          <Link href="/dashboard" className="btn-main">Try AI Chef Free 🚀</Link>
          <Link href="/login" className="btn-ghost">Log Into Account</Link>
        </div>
        ...
        <div className="container">
          ...
          <div className="feat-grid">
            {[
              ...
              <div className="feat-card" key={i} style={{ '--c': f.c }}>
          ...
          <div className="pricing-grid">
            {[
              ...
              <div key={i} className={`price-card ${p.accent ? 'featured' : ''}`}>
                ...
                <Link href="/dashboard" className={`btn-price ${p.accent ? 'btn-price-accent' : 'btn-price-outline'}`}>{p.cta}</Link>
              </div>
            ))}
          </div>
        </div>
      ...
      <section>
        <div className="cta-box">
          ...
          <div className="cta-btns">
            <Link href="/dashboard" className="btn-main">Start Eating Smarter 🚀</Link>
            <Link href="/login" className="btn-ghost">Log Into Account</Link>
          </div>
        </div>
      </section>
...
/* ── Hamburger + Mobile Drawer (client-side state) ── */
function HamburgerButton() {
  ...
  return (
    <div className="nav-hamburger" onClick={onClick} aria-label="Open menu">
      <span /><span /><span />
    </div>
  );
}
...
function MobileNavDrawer() {
  ...
  return (
    <div className="nav-mobile-drawer" id="mobile-nav-drawer">
      ...
      <div className="nav-mobile-ctas">
        <Link href="/login" className="btn-nav-ghost" onClick={close}>Log In</Link>
        <Link href="/dashboard" className="btn-nav-main" onClick={close}>Try Free 🚀</Link>
      </div>
    </div>
  );
}